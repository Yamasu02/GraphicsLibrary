...
public:
    ...
    static inline Microsoft::WRL::ComPtr<IDXGIDevice> dxgiDevice;
    static inline Microsoft::WRL::ComPtr< ID2D1Device> dev;
   ...
   /* D3D_FEATURE_LEVEL featureLevels [7] =
    ...
    ConstructBase(HWND hwnd)
    {
        ...
        //    &lvl,            // returns feature level of device created
       ...
       // pDirect2dFactory->CreateDevice(dxgiDevice.Get(), &dev);
